...
public abstract class URLConnection {
    ...
    public void setDoInput(boolean doinput) {
        System.out.println("########=sdsgs2232323");
        if (connected)
            ...
            throws UnknownServiceException
    {
        ...
        if (handler == null) {
            try {
                ...
                e.printStackTrace();
                handler = java.net.UnknownContentHandler.INSTANCE;
            }
    ...
    private ContentHandler lookupContentHandlerClassFor(String contentType)
        ...
        return java.net.UnknownContentHandler.INSTANCE;
    }
...
class UnknownContentHandler extends ContentHandler {
    static final ContentHandler INSTANCE = new java.net.UnknownContentHandler();

    public Object getContent(java.net.URLConnection uc) throws IOException {
